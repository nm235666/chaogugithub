...
export MCP_WRITE_ENABLED="${MCP_WRITE_ENABLED:-0}"
...
export DECISION_TRADE_ADVISOR_AGENT_ENABLED="${DECISION_TRADE_ADVISOR_AGENT_ENABLED:-1}"
export DECISION_TRADE_ADVISOR_AGENT_SYNC="${DECISION_TRADE_ADVISOR_AGENT_SYNC:-0}"
export DECISION_TRADE_ADVISOR_AGENT_LIMIT="${DECISION_TRADE_ADVISOR_AGENT_LIMIT:-3}"
