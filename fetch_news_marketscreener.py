...
DEFAULT_SOURCE = "marketscreener_byd_news"
DEFAULT_URL = "https://www.marketscreener.com/quote/stock/BYD-COMPANY-LIMITED-693358/news/"
DEFAULT_LINK = "https://www.marketscreener.com/"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="抓取 MarketScreener 新闻页并入库 news_feed_items")
    parser.add_argument(
        "--db-path",
    ...
    parser.add_argument("--category", default="国际个股新闻", help="新闻分类")
    ...
    parser.add_argument("--limit", type=int, default=30, help="本次最多入库条数")
    ...
    try:
        ...
        if inserted_items:
            publish_news_batch(
                ...
                producer="fetch_news_marketscreener.py",
            )
    finally:
        conn.close()
    return 0
